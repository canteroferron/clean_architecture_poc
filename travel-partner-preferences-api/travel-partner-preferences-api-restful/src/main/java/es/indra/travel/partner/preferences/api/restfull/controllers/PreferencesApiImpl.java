...
import es.indra.travel.partner.preferences.api.restfull.model.PreferencesDto;
...
public class PreferencesApiImpl implements PreferencesApiDelegate {
    ...
    @Override
    public ResponseEntity<PreferencesDto> addPreferences(PreferencesDto preferencesDto) {
        ...
        //Convert to api
        PreferencesDto preferencesDtoToReturn = new PreferencesDto();
    ...
    @Override
    public ResponseEntity<PreferencesDto> updatePreferences(PreferencesDto preferencesDto) {
        //Conversion to domain
        Preferences preferences = new Preferences();
        preferences.setUserId(preferencesDto.getUserId());
        preferences.setDescription(preferencesDto.getDescription());
